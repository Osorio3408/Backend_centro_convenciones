...
const Footer_register = () => {
  return (
    <>
      <footer class="w-full border-white border-t-2 p-4 fixed bottom-0 text-center bg-sky-900 rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-sky-900 xl:h-24 ">
        ...
        <ul class="flex flex-wrap justify-center items-center mt-3 text-sm text-gray-500 dark:text-teal-100 sm:mt-0">
          <li>
            <a href="#" class="mr-4 hover:underline md:mr-6 xl:text-xl ">
          ...
          <li>
            <a href="#" class="hover:underline xl:text-xl ">
              Contactanos
            </a>
          </li>
        </ul>
